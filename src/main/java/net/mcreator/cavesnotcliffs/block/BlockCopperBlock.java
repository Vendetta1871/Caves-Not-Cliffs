...
public class BlockCopperBlock extends ElementsCavesNotCliffs.ModElement {
    ...
    public BlockCopperBlock(ElementsCavesNotCliffs instance) { super(instance, 45); }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("copper_block"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
            new ModelResourceLocation("cavesnotcliffs:copper_block", "inventory"));
    }
    ...
    private static class BlockCustom extends Block {
        ...
        public void randomTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
            if (!worldIn.isRemote && rand.nextInt(100) == 0) {
                worldIn.setBlockState(pos, BlockCopperBlockStage1.block.getDefaultState());
            }
        }
    }
}
