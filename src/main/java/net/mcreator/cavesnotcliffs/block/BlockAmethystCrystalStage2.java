...
public class BlockAmethystCrystalStage2 extends ElementsCavesNotCliffs.ModElement {
    @GameRegistry.ObjectHolder("caves_and_cliffs:amethyst_crystal_stage_2")
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
            new ModelResourceLocation("caves_and_cliffs:amethyst_crystal_stage_2", "inventory"));
    }
        ...
        public void randomTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
            if (!worldIn.isRemote && rand.nextInt(5) == 0) {
                ...
                if (below.getBlock() == BlockAmethystGeode.block || below.getBlock() == BlockGeodeCasing.block) {
                    worldIn.setBlockState(pos, BlockAmethystCrystal.block.getDefaultState());
                }
            }
        }
    }
