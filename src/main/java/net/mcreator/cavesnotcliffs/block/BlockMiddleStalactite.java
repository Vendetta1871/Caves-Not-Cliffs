...
public class BlockMiddleStalactite extends ElementsCavesNotCliffs.ModElement {
    @GameRegistry.ObjectHolder("cavesnotcliffs:middle_stalactite")
    public static final Block block = null;

    public BlockMiddleStalactite(ElementsCavesNotCliffs instance) { super(instance, 22); }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("middle_stalactite"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
            new ModelResourceLocation("cavesnotcliffs:middle_stalactite", "inventory"));
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.ROCK);
            setUnlocalizedName("middle_stalactite");
        ...
        private boolean hasValidSupport(World worldIn, BlockPos pos) {
            ...
            return above == BlockBottomStalactite.block || above == BlockMiddleStalactite.block;
        }
