...
public class ElementsCavesNotCliffs implements IFuelHandler, IWorldGenerator {
	...
	public void preInit(FMLPreInitializationEvent event) {
		try {
			for (ASMDataTable.ASMData asmData : event.getAsmData().getAll(ModElement.Tag.class.getName())) {
				...
				if (clazz.getSuperclass() == ElementsCavesNotCliffs.ModElement.class)
					elements.add((ElementsCavesNotCliffs.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final ElementsCavesNotCliffs elements;
		protected final int sortid;
		public ModElement(ElementsCavesNotCliffs elements, int sortid) {
