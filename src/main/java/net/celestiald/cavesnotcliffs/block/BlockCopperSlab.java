...
public class BlockCopperSlab extends ElementsCavesNotCliffs.ModElement {
    @GameRegistry.ObjectHolder("cavesnotcliffs:copper_slab")
    public static final Block block = null;

    @GameRegistry.ObjectHolder("cavesnotcliffs:copper_slab_double")
    ...
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("copper_slab"));
        elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("copper_slab_double"));
    ...
    public static class BlockCustom extends BlockSlab {
        ...
        public BlockCustom() {
            super(Material.IRON);
            setUnlocalizedName("copper_slab");
