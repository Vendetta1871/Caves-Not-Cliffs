...
public class BlockCopperSlab extends ElementsCavesNotCliffs.ModElement {
    @GameRegistry.ObjectHolder("cavesnotcliffs:cut_copper_slab")
    public static final Block block = null;

    @GameRegistry.ObjectHolder("cavesnotcliffs:cut_copper_slab_double")
    public static final Block block_slab_double = null;

    public BlockCopperSlab(ElementsCavesNotCliffs instance) { super(instance, 50); }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("cut_copper_slab"));
        elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("cut_copper_slab_double"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
            new ModelResourceLocation("cavesnotcliffs:copper_slab", "inventory"));
    }
    ...
    public static class BlockCustom extends BlockSlab {
        ...
        public BlockCustom() {
            super(Material.IRON);
            setUnlocalizedName("cut_copper_slab");
