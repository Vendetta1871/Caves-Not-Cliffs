...
public class BlockBottomStalagmite extends ElementsCavesNotCliffs.ModElement {
    @GameRegistry.ObjectHolder("cavesnotcliffs:bottom_stalagmite")
    public static final Block block = null;

    public BlockBottomStalagmite(ElementsCavesNotCliffs instance) { super(instance, 24); }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("bottom_stalagmite"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
            new ModelResourceLocation("cavesnotcliffs:bottom_stalagmite", "inventory"));
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.ROCK);
            setUnlocalizedName("bottom_stalagmite");
