...
public class BlockAmethystCrystalStage2 extends ElementsCavesNotCliffs.ModElement {
    @GameRegistry.ObjectHolder("cavesnotcliffs:amethyst_crystal_stage_2")
    ...
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("cavesnotcliffs", "amethyst_crystal_stage_2"));
        elements.items.add(() -> {
            Block b = ForgeRegistries.BLOCKS.getValue(new ResourceLocation("cavesnotcliffs", "amethyst_crystal_stage_2"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        Item item = ForgeRegistries.ITEMS.getValue(new ResourceLocation("cavesnotcliffs", "amethyst_crystal_stage_2"));
        if (item != null)
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.ROCK);
            setUnlocalizedName("amethyst_crystal_stage_2");
        ...
        public void randomTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
            if (!worldIn.isRemote && rand.nextInt(5) == 0) {
                ...
                Block crystal = ForgeRegistries.BLOCKS.getValue(new ResourceLocation("cavesnotcliffs", "amethyst_crystal"));
