...
public class BlockMiddleStalagmite extends ElementsCavesNotCliffs.ModElement {
    @GameRegistry.ObjectHolder("cavesnotcliffs:middle_stalagmite")
    public static final Block block = null;

    public BlockMiddleStalagmite(ElementsCavesNotCliffs instance) { super(instance, 25); }
